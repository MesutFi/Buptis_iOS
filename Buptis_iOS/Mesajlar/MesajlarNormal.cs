...
{
    public partial class MesajlarNormal : UIView
    {
        #region Tanimlamalar
        ...
        UITextField AraTxt;
        #endregion
        public MesajlarNormal(IntPtr handle) : base(handle)
        {
        }
        public static MesajlarNormal Create(MesajlarBaseVC GelenBase2, UITextField AraTxt2)
        {
            var arr = NSBundle.MainBundle.LoadNib("MesajlarNormal", null, null);
            var v = Runtime.GetNSObject<MesajlarNormal>(arr.ValueAt(0));
        ...
        public class MesajlarCustomTableCellSoruce : UITableViewSource
        {
            ...
            MesajlarNormal MesajlarNormal1;
            List<string> FollowListID;
            public MesajlarCustomTableCellSoruce(List<MesajKisileri> mekanlist, MesajlarNormal MesajlarNormal2,List<string> FollowListt)
            {
                TableItems = mekanlist;
                MesajlarNormal1 = MesajlarNormal2;
            ...
            public override void RowSelected(UITableView tableView, NSIndexPath indexPath)
            {
                ...
                MesajlarNormal1.RowSelectt(item);
            }
        }
    }
}
