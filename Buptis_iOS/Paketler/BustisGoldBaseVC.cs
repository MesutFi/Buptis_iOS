...
namespace Buptis_iOS
{
    public partial class BustisGoldBaseVC : UIViewController
    {
        ...
        void PaketSatinAlmaUzakDBAyarla(int Miktar)
        {
            ...
            if (Donus != "Hata")
            {
                CustomAlert.GetCustomAlert(this, Miktar + " Aylık Gold Paket Satın Aldınız.");
        ...
        void CreateScrollViews()
        {
            ...
            AciklamaText = "Daha çok kişiyle sohbet edin!",
            ImageName = "gold_icon1.png"
            });
            slideContents.Add(new SlideContent()
            {
                AciklamaText = "İsterseniz kimliğinizi gizleyin!",
                ImageName = "gold_icon2.png"
            });
            slideContents.Add(new SlideContent()
            {
                AciklamaText = "Her ay 3 Boost kazanın!",
                ImageName = "gold_icon3.png"
            });
            slideContents.Add(new SlideContent()
            {
                AciklamaText = "Her ay 3 Super Boost kazanın!",
                ImageName = "gold_icon5.png"
            });
            slideContents.Add(new SlideContent()
            {
                AciklamaText = "Anında 1000 Kredi kazanın!",
