...
{
    public partial class LokasyondakiKisilerCevrimici : UIView
    {
        #region Tanimlamalar
        ...
        #endregion
        public LokasyondakiKisilerCevrimici(IntPtr handle) : base(handle)
        {
        }

        public static LokasyondakiKisilerCevrimici Create(Mekanlar_Location GelenMekan2, LokasyondakiKisilerBaseVC gelenbase2)
        {
            var arr = NSBundle.MainBundle.LoadNib("LokasyondakiKisilerCevrimici", null, null);
            var v = Runtime.GetNSObject<LokasyondakiKisilerCevrimici>(arr.ValueAt(0));
