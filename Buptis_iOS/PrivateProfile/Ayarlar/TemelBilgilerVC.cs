...
namespace Buptis_iOS
{
    public partial class TemelBilgilerVC : UIViewController
    {
        ...
        private void BirthdayButton_TouchUpInside(object sender, EventArgs e)
        {
            ...
            dialog.Show("Doğum Tarihi Seçin", "Tamam", "Vazgeç", UIDatePickerMode.Date, (dt) =>
            {
        ...
        {
            AdSoyadTxt.AttributedPlaceholder = new NSAttributedString("İsminiz..", null, UIColor.White.ColorWithAlpha(0.5f));
